...
export const SKIN_PRESETS = {
  ...
  doppler: { name: 'Doppler', pattern: 'splatter', c1: '#140c2e', c2: '#7b2ff7', c3: '#ff4fb8', finish: 'metallic', wear: 0, scale: 1.4, seed: 17, zones: { stock: 'black', grip: 'black', foregrip: 'black', butt: 'black', handle: 'black' }, fx: { type: 'spectral', color: '#b36bff', glow: true } },
  tigertooth: { name: 'Tiger Tooth', pattern: 'stripes', c1: '#f5a623', c2: '#7a3b06', c3: '#000000', finish: 'metallic', wear: 0, scale: 1, seed: 8, zones: { stock: 'black', grip: 'black', foregrip: 'black', butt: 'black', handle: 'black' }, fx: { type: 'flame', color: '#ffb02e', glow: false } },
  smoke: { name: 'Smoke Glass', pattern: 'solid', c1: '#6d7580', c2: '#aab3bd', c3: '#2d3238', finish: 'clear', wear: 0, scale: 1, seed: 3, zones: { grip: 'black', mag: 'clearTint', suppressor: 'black', scope: 'black', butt: 'black', handle: 'black' }, fx: { type: 'tracer', color: '#e6edf5', glow: false } },
