...
import { botHitboxes, directionFromAngles, hitTest, rayCapsule, raySphere } from '../src/game/hit.js';
import { DIFFICULTIES, EYE_HEIGHT, resolveDifficulty, SCENARIOS } from '../src/game/scenarios.js';
...
describe('ray tests', () => {
  ...
  it('separates head and body on the bot', () => {
    const bot = { kind: 'bot', position: { x: 0, y: 0, z: -15 }, scale: 1 };
    const { head, body } = botHitboxes(bot);
